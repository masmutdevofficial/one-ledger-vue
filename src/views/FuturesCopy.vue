    ...
    >
      ...
      <div>
        ...
        <ul class="list-disc pl-5 space-y-1 mt-1">
          <li>
            Each member who wishes to participate in the collective trading pool must deposit funds
          ...
          <li>
            All trading activities within the Pool are directed by the Master Trader. While entry
            (opening) may be performed manually by members following the minimum requirements, all
            closing of positions is executed collectively and automatically.
          </li>
      ...
      <div>
        ...
        <ul class="list-disc pl-5 space-y-1 mt-1">
          <li>
            Trading positions are opened according to the applied strategy, with members required to
            follow the minimum entry instructions.
          </li>
          <li>
            Closing of all trading positions is executed collectively and automatically under the
            Master Trader’s direction.
          </li>
          <li>
      ...
      <div>
        ...
        <ul class="list-disc pl-5 space-y-1 mt-1">
          ...
          <li>
            Final results will be displayed on the dashboard and can be withdrawn once the session
            is completed.
          </li>
          <li>
      ...
      <div>
        ...
        <ul class="list-disc pl-5 space-y-1 mt-1">
          <li>
            ...
            balance, or attempts to withdraw funds early), their funds will remain locked until the
            entire trading session ends.
          </li>
      ...
      <div>
        ...
        <ul class="list-disc pl-5 space-y-1 mt-1">
          ...
          <li>Profit is not guaranteed in every session as results depend on market conditions.</li>

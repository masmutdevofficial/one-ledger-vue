<template>
  ...
  >
    <SwiperSlide v-for="s in slides" :key="s.src">
      ...
      >
        <img :src="s.src" :alt="s.alt" class="block w-full h-[80px]" />
      </button>
      ...
      >
        ...
        <div>
          ...
          <ul class="list-disc pl-5 space-y-1 mt-1">
            ...
            <li>
              All trading activities within the Pool are executed under the direction of the Master
              Trader, with positions opened and closed on behalf of all members.
            </li>
